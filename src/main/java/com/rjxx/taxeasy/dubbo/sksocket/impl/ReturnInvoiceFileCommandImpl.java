...
import com.rjxx.taxeasy.dao.dto.ReturnInvoiceFile;
import com.rjxx.taxeasy.dubbo.sksocket.command.ReturnInvoiceFileCommandService;
...
/**
 *@ClassName ReturnInvoiceFileCommandImpl
 *@Description 客户端返回电票开票数据处理的实现类
 *@Author 许黎明
 *@Date 2018/3/29.
 *@Version 1.0
 **/
